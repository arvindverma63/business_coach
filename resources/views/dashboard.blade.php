<x-app-layout title="Dashboard | BestBusinessCoachIndia Admin">
    <div class="container-fluid">
        ...
        @cannot('coaches.view', 'seekers.view', 'enquries.view')
            <div class="alert alert-warning alert-dismissible fade show mb-3" role="alert">
                <i class="mdi mdi-alert-circle me-2"></i>
                <strong>Limited Access</strong> - You don't have permission to view dashboard analytics. Contact your administrator.
        ...
        {{-- Recent Coach Onboarding Requests Table --}}
        @can('coaches.view')
            <div class="row">
                <div class="col-xl-12">
